...
export class FlechaDoble implements AfterViewInit, OnInit {
  mousePos = null;
  slider: any;
  sliderTxt: any
  playAnim = false;
  ...
  drawLine() {
    ...
    var arrowAngle = Math.atan2(this.points[2].x - this.points[3].x, this.points[2].y - this.points[3].y) + Math.PI;
    var arrowAngle2 = Math.atan2(this.points[1].x - this.points[0].x, this.points[1].y - this.points[0].y) + Math.PI;
    var arrowWidth = 20;
    this.context.beginPath();
    ...
    this.context.beginPath();
    this.context.moveTo( this.points[3].x - (arrowWidth * Math.sin(arrowAngle - Math.PI / 6)), 
    this.points[3].y - (arrowWidth * Math.cos(arrowAngle - Math.PI / 6)));
    this.context.lineTo( this.points[3].x, this.points[3].y );
    this.context.lineTo( this.points[3].x - (arrowWidth * Math.sin(arrowAngle + Math.PI / 6)), 
    this.points[3].y - (arrowWidth * Math.cos(arrowAngle + Math.PI / 6)) );
    this.context.stroke();

    this.context.beginPath();
    this.context.moveTo( this.points[0].x - (arrowWidth * Math.sin(arrowAngle2 - Math.PI / 6)), 
    this.points[0].y - (arrowWidth * Math.cos(arrowAngle2 - Math.PI / 6)));
    this.context.lineTo( this.points[0].x, this.points[0].y );
    this.context.lineTo( this.points[0].x - (arrowWidth * Math.sin(arrowAngle2 + Math.PI / 6)), 
    this.points[0].y - (arrowWidth * Math.cos(arrowAngle2 + Math.PI / 6)) );
    this.context.stroke();
